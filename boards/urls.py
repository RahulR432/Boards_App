...
#from .views import UserUpdateView, PostUpdateView, BoardListView

urlpatterns = [
    # url(r'^$', views.home, name='home'), # Function Based View
    url(r'^$', views.BoardListView.as_view(), name='home'), # Class Based View
